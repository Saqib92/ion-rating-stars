...
const ItemDivider = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '5727179159ef2a8879f55435265003e0ec72df3f', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-divider-sticky': this.sticky,
                item: true,
            }) }, index.h("slot", { key: 'bb7df137e60ca3fa9a50c612e30fbb3ee4c818ad', name: "start" }), index.h("div", { key: '6a25a01271957cfdd8e8dfb6ef76e1eb710380f2', class: "item-divider-inner" }, index.h("div", { key: '554ba681b0f346ed0af03232f8b2e6ca399877d9', class: "item-divider-wrapper" }, index.h("slot", { key: 'f98e20a01f09d0a2e19b7351eb1b4028881a07ab' })), index.h("slot", { key: '755643b5b8d3463af41b3d0805871073a34386a3', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
ItemDivider.style = {
...
const ItemGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '5778fb7e9c6791874b4ff14f0babdae715e322e7', role: "group", class: {
                [mode]: true,
...
const Label = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '72ad4ba5c1137ae0130e421346668e436ea53bf8', class: theme.createColorClasses(this.color, {
                [mode]: true,
...
const List = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3df401155114c7a39c81f201bf8a181d07e8d4c8', role: "list", class: {
                [mode]: true,
                // Used internally for styling
                [`list-${mode}`]: true,
                'list-inset': inset,
...
const ListHeader = class {
    ...
    render() {
        const { lines } = this;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'e5fabb3ae91e6fe47c89273d1d2dba5902f77f94', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`list-header-lines-${lines}`]: lines !== undefined,
            }) }, index.h("div", { key: 'a9cfdaa436267fbabb0d618c3932849c1b77fbd2', class: "list-header-inner" }, index.h("slot", { key: '8ed806fd58f8f2265c5bf466886086e88ada93cc' }))));
    }
};
ListHeader.style = {
