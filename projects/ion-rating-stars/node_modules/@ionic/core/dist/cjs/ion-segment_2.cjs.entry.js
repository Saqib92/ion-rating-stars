...
const Segment = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '01c94f9fcc51fb5a7612588c87155a130b7c8a9d', role: "tablist", onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
            ...
            }) }, index.h("slot", { key: 'b0afdfcb7506a765df42d1d6eb4e1d81bf8fd92a' })));
    }
...
const SegmentButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'daed55711fdb550747d2ad5fb6e012bff6f6b176', class: {
                [mode]: true,
                'in-toolbar': theme.hostContext('ion-toolbar', this.el),
                'in-toolbar-color': theme.hostContext('ion-toolbar[color]', this.el),
                ...
                'ion-focusable': true,
            } }, index.h("button", Object.assign({ key: '851a4b8ff7e45f5fc559c4d8e9c3102441dbd10e', "aria-selected": checked ? 'true' : 'false', role: "tab", ref: (el) => (this.nativeEl = el), type: type, class: "button-native", part: "native", disabled: disabled }, this.inheritedAttributes), index.h("span", { key: 'b2dc87747e81ce49dfa1269355027d9380226a6a', class: "button-inner" }, index.h("slot", { key: '00e21fdcafb533605518beebb9557c724fc88e76' })), mode === 'md' && index.h("ion-ripple-effect", { key: '358c90ab1b43aae3bc6eb1e58fb38d4892894a68' })), index.h("div", { key: '20fd3f7c43dd117541314e852d894af855050707', part: "indicator", class: {
                'segment-button-indicator': true,
                'segment-button-indicator-animated': true,
            } }, index.h("div", { key: 'bebdeb84466c404d52ce48feda1ece5fb1f202b0', part: "indicator-background", class: "segment-button-indicator-background" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueChanged"]
