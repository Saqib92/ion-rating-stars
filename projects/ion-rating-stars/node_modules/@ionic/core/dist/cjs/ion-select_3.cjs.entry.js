...
const SelectOption = class {
    ...
    render() {
        return index.h(index.Host, { key: 'abf6e85d60e815f59077910abec922826bf46eb2', role: "option", id: this.inputId, class: ionicGlobal.getIonMode(this) });
    }
    get el() { return index.getElement(this); }
};
...
const SelectPopover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ddf45e058c75aae175f8589e3539ff152a5b47ad', class: ionicGlobal.getIonMode(this) }, index.h("ion-list", { key: '52dbf712bf6cbdcb9d2e6223b99c67ecc90977ff' }, header !== undefined && index.h("ion-list-header", { key: '692fc85c97591f09a2a9b0bccc8f71e97681cc09' }, header), hasSubHeaderOrMessage && (index.h("ion-item", { key: 'ecab23444eaadc3ed21e7053d50890db1012475f' }, index.h("ion-label", { key: '639f08137d7066fd79316f63e850ddcc6a3b54a7', class: "ion-text-wrap" }, subHeader !== undefined && index.h("h3", { key: 'dc501101ac9d68b1d0ce80679b339a2b132d1ae9' }, subHeader), message !== undefined && index.h("p", { key: '5ead8c1a2e90d29fe0f05e04a9fa65c7e9e62ca5' }, message)))), this.renderOptions(options))));
    }
    get el() { return index.getElement(this); }
};
SelectPopover.style = {
