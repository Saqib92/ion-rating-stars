...
const Reorder = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5747b63aa64b05bfed96bbce8087186c7e14c6d5', class: mode }, index.h("slot", { key: 'a745f29a23c905cd0bff572acb755b597a3fb3c3' }, index.h("ion-icon", { key: '48f433e85a3a68c16bc426623b2b74957b4b2eb7', icon: reorderIcon, lazy: false, class: "reorder-icon", part: "icon", "aria-hidden": "true" }))));
    }
...
const ReorderGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '68b5e5fa00a0531c74597964d84c82da8bc3252f', class: {
                [mode]: true,
