...
const TabBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5083528e7f802d2f323ce50585edc98eeb9754c6', role: "tablist", "aria-hidden": shouldHide ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                'tab-bar-translucent': translucent,
                'tab-bar-hidden': shouldHide,
            }) }, index.h("slot", { key: 'eb33cdd12da49062219d4aa17a319c3e6361c5c5' })));
    }
...
const TabButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c7b6a72766b71f34800137dadcf29af657bebddf', onClick: this.onClick, onKeyup: this.onKeyUp, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                [mode]: true,
