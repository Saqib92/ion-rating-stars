...
const index$1 = require('./index-5c38afe7.js');
...
const MenuButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7a4543dfcbf559f0d3a473683f8e0bd1d4c3542a', onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                ...
                'ion-focusable': true,
            }) }, index.h("button", Object.assign({ key: '2b6944dc130fa765ac7559077254555583529ec3' }, attrs, { disabled: disabled, class: "button-native", part: "native", "aria-label": ariaLabel }), index.h("span", { key: 'b4d1006bec8c9e761c64ae3e2fb64848dfc30307', class: "button-inner" }, index.h("slot", { key: 'eaf1d57cd2e841c70095821576c52062dc76500b' }, index.h("ion-icon", { key: '105ddb806aae2e6add6cb3989fd4a5cf5ee7d952', part: "icon", icon: menuIcon, mode: mode, lazy: false, "aria-hidden": "true" }))), mode === 'md' && index.h("ion-ripple-effect", { key: '8a312aab747de2bdd6adee74fb0bfcbbde12c191', type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
MenuButton.style = {
...
const MenuToggle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        const hidden = this.autoHide && !this.visible;
        return (index.h(index.Host, { key: '94a0815a634c6fb1991854bfbcf5b2b4b61d7710', onClick: this.onClick, "aria-hidden": hidden ? 'true' : null, class: {
                [mode]: true,
                'menu-toggle-hidden': hidden,
            } }, index.h("slot", { key: 'f3ac6d17d5421390ab05f3f31ad00ec4f2ca5c7c' })));
    }
};
