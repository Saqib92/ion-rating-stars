...
const ItemOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '763c3a7571b143d1068d85103ccab403bc48abae', onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-option-disabled': disabled,
                'item-option-expandable': expandable,
                'ion-activatable': true,
            }) }, index.h(TagType, Object.assign({ key: 'cb199c2ccd38abaad3460f184af3093bf08546cc' }, attrs, { class: "button-native", part: "native", disabled: disabled }), index.h("span", { key: 'f3ce9f1d343890c6f55f2609127f1e5113a2eedf', class: "button-inner" }, index.h("slot", { key: 'cd9434883c0bdb4129fb6f49970d49710653a09a', name: "top" }), index.h("div", { key: '764529c5f4b3d82105ce55885e8f121a91e8bc4a', class: "horizontal-wrapper" }, index.h("slot", { key: '5bbd7b9ed9f35c8bf422c3134a1a097e174ad6df', name: "start" }), index.h("slot", { key: '1e70a781cdf4ffcefb1dea70abe43655d7857c4b', name: "icon-only" }), index.h("slot", { key: 'c3205e9b1577a56786c10a8b5b420010b5fe53fc' }), index.h("slot", { key: '6bae6c98cd8d8526a203af47ca8e83753e1e1cb6', name: "end" })), index.h("slot", { key: '466cc32cdf9cbbdbb58e4b29144215cf2984c0d6', name: "bottom" })), mode === 'md' && index.h("ion-ripple-effect", { key: 'b5c54b801008b307ca8f718a41101be3e8d1d938' }))));
    }
...
const ItemOptions = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3dca0415ec2942ac8e87a057e26bcb290a892f65', class: {
                [mode]: true,
...
const ItemSliding = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '7f191e38bf717e6ccb246aa7b9fbd29d01e64677', class: {
                [mode]: true,
